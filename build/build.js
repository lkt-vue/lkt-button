import { defineComponent as Xe, mergeDefaults as Ye, useSlots as Ze, ref as s, watch as F, computed as a, resolveComponent as z, createElementBlock as p, openBlock as n, normalizeClass as K, createBlock as y, createCommentVNode as r, mergeProps as V, withCtx as q, renderSlot as M, toDisplayString as G, unref as J, Fragment as Q, createTextVNode as we, resolveDynamicComponent as Be, withDirectives as $e, withModifiers as Te, vShow as et, createSlots as Oe, renderList as Re } from "vue";
import { generateRandomString as tt } from "lkt-string-tools";
import { httpCall as ot } from "lkt-http-client";
import { openModal as lt, openConfirm as nt, runModalCallback as it } from "lkt-modal";
import { useRouter as ut } from "vue-router";
import { extractPropValue as L, ButtonType as o, extractI18nValue as ie, FieldType as Ee, getDefaultValues as at, Button as rt, LktSettings as Ie } from "lkt-vue-kernel";
const W = class W {
};
...
const St = (h = !0) => {
  ...
  setup(h, { expose: Fe, emit: Ve }) {
    const e = h, C = Ve, P = Ze(), ue = ut();
    let Me = L(e.modalKey, e.prop);
    const Le = "lkt-button-" + tt(), D = s(e.loading), w = s(null), X = s(null), T = s(!1), v = s(e.openTooltip), ae = s(!1), O = s(!1), R = s(void 0), f = s(e.checked), re = s(void 0), Y = s(!1), Z = s(null), $ = s(!1);
    ...
    const ce = a(() => {
    ...
    }), _ = a(() => typeof e.modal == "function" ? e.modal(e.prop) : L(e.modal, e.prop)), A = a(() => typeof e.modalData == "function" ? e.modalData(e.prop) : e.modalData), Ae = a(() => typeof B.defaultSplitIcon < "u"), He = a(() => B.defaultSplitIcon), fe = a(() => typeof e.dot == "boolean" ? "" : e.dot), b = (t, l = void 0) => {
      i("endClickMethod", t, l), _e(), qe(t === null ? void 0 : t, l), C("click", t, l);
    }, ee = a(() => {
    ...
    }, pe = s(!1), Ue = a(() => w.value ? e.type === o.TooltipLazy ? pe.value : e.type === o.TooltipEver ? v.value : e.type === o.Tooltip : !1), Ne = s(!1), xe = a(() => w.value ? e.type === o.SplitLazy ? Ne.value : e.type === o.SplitEver ? T.value : e.type === o.Split : !1), je = (t) => {
      if (Y.value = !0, $.value) {
        $.value = !1, C("focus");
        return;
      }
      ...
      Y.value = !1, C("blur", t);
    }, te = a(() => e.type === o.Switch || e.type === o.HiddenSwitch), Ke = a(() => e.type === o.Switch), oe = a(() => e.type === o.FileUpload || e.type === o.ImageUpload), Pe = a(() => e.type === o.ImageUpload ? Ee.Image : Ee.File), _e = () => {
      ...
      if (_.value) {
        ...
        let S = _.value;
        return typeof _.value == "function" && (S = _.value()), lt(S, Me, u);
      }
      if (e.confirmModal) {
        ...
        if (u.confirmButton ? u.confirmButton = { ...Ie.defaultConfirmButton, ...u.confirmButton } : u.confirmButton = { ...Ie.defaultConfirmButton }, u.confirmButton.events || (u.confirmButton.events = {}), typeof ((N = (k = u.confirmButton) == null ? void 0 : k.events) == null ? void 0 : N.click) == "function") {
          let S = (c = (x = u.confirmButton) == null ? void 0 : x.events) == null ? void 0 : c.click;
          ...
          u.confirmButton.events.click = () => {
            ...
            if (((S = e.anchor) == null ? void 0 : S.to) !== "") {
              t && (t.preventDefault(), t.stopPropagation()), (j = e.anchor) != null && j.external || typeof ((ge = e.anchor) == null ? void 0 : ge.to) < "u" && ue.push((De = e.anchor) == null ? void 0 : De.to);
              return;
            }
            b(t);
          }, i("Click -> New confirmData.events?.click function created: ", (ye = u.confirmButton) == null ? void 0 : ye.events.click);
        return nt(e.confirmModal, e.confirmModalKey, u);
      }
      if (e.resource)
        return i("Click -> has resource"), H(t);
      if (typeof ((he = e.anchor) == null ? void 0 : he.to) < "u" && ((Ce = e.anchor) == null ? void 0 : Ce.to) !== "") {
        i("Click -> Is Anchor", e.anchor), (be = e.anchor) != null && be.external ? typeof ((Se = e.anchor) == null ? void 0 : Se.to) == "string" && (window.location.href = e.anchor.to) : ue.push(e.anchor.to);
        return;
      }
      if (te.value) {
    ...
    const Ge = a(() => e.type === o.Content ? "div" : "button"), Je = a(() => {
      switch (e.type) {
        case o.Button:
        case o.Submit:
          return e.type;
    ...
    }), de = a(() => e.disabled === void 0 ? !1 : typeof e.disabled == "function" ? e.disabled({
      prop: e.prop
    }) : typeof e.disabled == "boolean" ? e.disabled : !1), ve = (t) => ne(t), Qe = (t) => ae.value = t, me = a(() => e.type === o.Anchor && typeof e.anchor == "object" && Object.keys(e.anchor).length > 0), We = a(() => me.value ? {
      ...e.anchor,
      class: ce.value,
      prop: e.prop
    } : {});
    return (t, l) => {
      ...
      return n(), p("div", {
        ...
        ref: w,
        id: Le,
        onMousemove: l[4] || (l[4] = (c) => O.value = !0),
        onMouseleave: l[5] || (l[5] = (c) => O.value = !1)
      }, [
        me.value ? (n(), y(d, V({ key: 0 }, We.value, {
          ...
          default: q(() => [
            ...
            E.value && t.dot ? (n(), p("i", ct, G(fe.value), 1)) : r("", !0),
            t.img ? (n(), p("img", {
              key: 2,
              src: t.img,
              alt: g.value
          ...
          default: q(() => [
            ...
            E.value && t.dot ? (n(), p("i", ft, G(fe.value), 1)) : r("", !0),
            t.img ? (n(), p("img", {
              key: 2,
              src: t.img,
              alt: g.value
            ...
            oe.value ? (n(), y(k, V({
              ...
              type: Pe.value,
              modelValue: re.value,
              "onUpdate:modelValue": l[1] || (l[1] = (c) => re.value = c),
              hidden: ""
            }, {
              fileUploadHttp: {
                resource: t.resource,
        ...
        U.value && w.value ? (n(), y(x, V({
          key: 2,
          modelValue: T.value,
          "onUpdate:modelValue": l[2] || (l[2] = (c) => T.value = c)
        }, t.tooltip, {
          referrer: w.value,
  ...
  install: (h) => {
    h.component("lkt-button") === void 0 && h.component("lkt-button", vt);
  }
}, Dt = (h) => {
